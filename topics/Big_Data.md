...
-   [Global Positioning Systems (GPS) Data](Global_Positioning_Systems_GPS_Data) - this data is based on line-of-sight with satellites and primarily comes from in-vehicle devices
-   [Location-Based Services (LBS)](Location_Based_Services_Data) or Smartphone Applications (App) Data - this data is based on the best location information available to a mobile device at a particular point in time and so may be a mix of GPS, Wifi or Bluetooth beacon or cellular data
