...
|                                                                                                       |                                             |
|-------------------------------------------------------------------------------------------------------|---------------------------------------------|
| ![Sample 24-hour Time Use Pattern](TimeUsePattern.png "Sample 24-hour Time Use Pattern") | ![](ActivityPurposeLegend_png) |
...
Woodward, W.A., H.L. Gray, and A. Elliott (2011) [Applied Time Series Analysis](https://www.crcpress.com/Applied-Time-Series-Analysis-with-R/Woodward-Gray-Elliott/p/book/9781498734226). CRC Press.
...
Zeid, M.A., T.F. Rossi, and B. Gardner (2006) [Modeling time-of-day choice in context of tour and activity-based models](https://journals.sagepub.com/doi/abs/10.1177/0361198106198100107/). *Transportation Research Record: Journal of the Transportation Research Board* **1981**, pp. 42-49.
